...
class Progrem extends StatefulWidget {
  const Progrem({Key? key}) : super(key: key);

  @override
  _ProgremState createState() => _ProgremState();
}
...
class _ProgremState extends State<Progrem> {
  String? pid;
  String? pname;
  String? pStu;
  String? ps;
  ...
  Future getNow() async {
    ...
    if (Numbers.data1 != null) {
      setState(() {
        pid = Numbers.data1!.pid;
        pname = Numbers.data1!.pname;
        pStu = Numbers.data1!.pStu;
        ps = Numbers.data1!.ps;
        pState = int.parse(Numbers.data1!.pState!);
        pNumbyTeacher = Numbers.data1!.pNumbyTeacher;
        pNum = Numbers.data1!.pNum;
        pCommit = Numbers.data1!.pCommit;
        purl = Numbers.data1!.pUrl;
