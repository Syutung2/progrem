...
class TeacherMinePage extends StatefulWidget {
  const TeacherMinePage({Key? key}) : super(key: key);

  @override
  _TeacherMinePageState createState() => _TeacherMinePageState();
}

class _TeacherMinePageState extends State<TeacherMinePage> {
  var name,username,zhichen;
  Future getString() async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    setState(() {
      username = sharedPreferences.get("username");
      name = sharedPreferences.get("name");
      zhichen = sharedPreferences.get("zhichen");
    });
  }
  ...
  Widget getUserInformation() {
    ...
    height: 60,
      ...
      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => StudentLoginPage()));
